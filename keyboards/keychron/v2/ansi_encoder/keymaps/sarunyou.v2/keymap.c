...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_67(
        ...
        KC_LCTL, KC_LOPT, MO(_FN1),                            KC_SPC,                             KC_RCMD, MO(_FN1), MO(_FN3), KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FN1] = LAYOUT_ansi_67(
        ...
        _______, RGB_RMOD, RGB_VAD,  RGB_HUD, RGB_SAD, RGB_SPD, KC_CAPS, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,  _______,            _______,          _______,
