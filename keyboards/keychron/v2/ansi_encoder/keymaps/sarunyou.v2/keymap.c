...
#define HOME_SCLN LT(_FN2, KC_SCLN)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_67(
        ...
        MT(MOD_LCTL,KC_ESC), HOME_A,   HOME_S,  HOME_D,  HOME_F,  KC_G,  KC_H,    HOME_J,  HOME_K,  HOME_L,   HOME_SCLN,KC_QUOT,  KC_ENT,           KC_HOME,
        KC_LSFT,           HOME_Z,     KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   HOME_SLASH,            KC_RSFT, KC_UP,
        KC_LCTL, KC_LOPT, MO(_FN1),                            KC_SPC,                             MO(_FN2), MO(_FN1), MO(_FN3), KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FN1] = LAYOUT_ansi_67(
        KC_GRV,  KC_BRID,  KC_BRIU,  KC_MCTL, KC_LPAD, RGB_VAD, RGB_VAI, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,          KC_VOLU,
    ...
    [_FN2] = LAYOUT_ansi_67(
        ...
        _______, KC_QUOT, KC_LABK, KC_RABK, KC_DQUO, KC_GRV,  KC_AMPR, KC_SCLN, KC_LBRC, KC_RBRC, KC_PERC, _______, _______, _______, _______,
        _______, HOME_EXLM_SYMBOL, HOME_MINS_SYMBOL, HOME_PLUS_SYMBOL, HOME_EQL_SYMBOL,  KC_HASH, KC_PIPE, HOME_COLON_SYMBOL, HOME_LPRN_SYMBOL, HOME_RPRN_SYMBOL, HOME_QUES_SYMBOL, _______,          _______, _______,
        _______,          KC_CIRC, KC_SLSH, KC_ASTR,  KC_UNDS, KC_BSLS,  KC_TILD, KC_DLR,  KC_LCBR, KC_RCBR, KC_AT,  _______, _______,
